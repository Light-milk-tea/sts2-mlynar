...
namespace MyFirstMod.MyFirstModCode.Cards;
...
/// </summary>
[Pool(typeof(TrialistCardPool))]
public abstract class MyFirstModCard(int cost, CardType type, CardRarity rarity, TargetType target) :
